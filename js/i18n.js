...
const translations = {
    it: {
        ...
        log_data_loaded: "Loaded survey_archetypes.json v4.4 - {questions} domande, {archetypes} archetipi ({list})",

        // Survey Selector
        survey_selector_label: "Tipo di sondaggio",
        survey_bcb_v3_name: "Behavioural & Competency-Based",
        survey_bcb_v3_short: "Behavioural & Competency-Based v4.4",

        // Behavioural & Competency-Based v4.4 Questions
        bcb3_q1_stem: "Un imprevisto cambia i tuoi piani. Come reagisci?",
        bcb3_q1_opt_a: "Trovo una soluzione pratica e riparto.",
        bcb3_q1_opt_b: "Sperimento un modo diverso e mi adatto rapidamente.",
        bcb3_q1_opt_c: "Mi confronto con qualcuno e decidiamo insieme come procedere.",
        bcb3_q1_opt_d: "Controllo con attenzione cosa è cambiato, un passo alla volta.",

        bcb3_q2_stem: "Hai svariati compiti da portare a termine e poco tempo. Da dove inizi?",
        bcb3_q2_opt_a: "Decido cosa affrontare per primo e mi metto all'opera.",
        bcb3_q2_opt_b: "Faccio un passo indietro, analizzo la situazione nel suo insieme e definisco le priorità.",
        bcb3_q2_opt_c: "Parto da ciò che posso chiudere subito e vado avanti.",
        bcb3_q2_opt_d: "Sblocco ciò che sta fermando tutto.",
        ...
        bcb3_q4_opt_a: "Condivido le informazioni per allineare tutti.",
        bcb3_q4_opt_b: "Aiuto il gruppo a coordinarsi e a dividersi i compiti.",
        bcb3_q4_opt_c: "Scelgo come procedere e propongo azioni precise.",
        bcb3_q4_opt_d: "Mi occupo subito di ciò che non può aspettare.",

        bcb3_q5_stem: "Collaborando con un'altra persona nasce un fraintendimento e la tensione aumenta. Come ti comporti?",
        ...
        bcb3_q7_stem: "Ti accorgi che una procedura può essere migliorata. Cosa fai?",
        bcb3_q7_opt_a: "Faccio una piccola prova per vedere se funziona.",
        bcb3_q7_opt_b: "Scelgo pochi passi chiari e li applico immediatamente.",
        bcb3_q7_opt_c: "Raccolgo i punti di vista di chi è coinvolto per trovare la soluzione migliore.",
        bcb3_q7_opt_d: "Valuto vantaggi e possibili rischi prima di agire.",

        bcb3_q8_stem: "Devi preparare qualcosa di importante anche per altre persone. Come procedi?",
        bcb3_q8_opt_a: "Mi assicuro che ogni dettaglio sia fatto bene.",
        bcb3_q8_opt_b: "Coinvolgo gli altri per costruire insieme il modo migliore di farlo.",
        bcb3_q8_opt_c: "Individuo il modo più concreto per portarlo a termine.",
    ...
    en: {
        ...
        log_data_loaded: "Loaded survey_archetypes.json v4.4 - {questions} questions, {archetypes} archetypes ({list})",
        ...
        // Behavioural & Competency-Based v4.4 Questions
        bcb3_q1_stem: "Something unexpected disrupts your plans. How do you respond?",
        bcb3_q1_opt_a: "I find a practical fix and carry on.",
        bcb3_q1_opt_b: "I try a different approach and adapt quickly.",
        bcb3_q1_opt_c: "I speak to someone and decide together how to proceed.",
        bcb3_q1_opt_d: "I assess what has changed, step by step.",

        bcb3_q2_stem: "You have several tasks to complete and limited time. Where do you begin?",
        bcb3_q2_opt_a: "I decide what to tackle first and get to work.",
        bcb3_q2_opt_b: "I step back, assess the bigger picture, and set priorities.",
        bcb3_q2_opt_c: "I start with something I can complete quickly, then move on.",
        bcb3_q2_opt_d: "I remove the blocker that's holding everything up.",
        ...
        bcb3_q4_opt_a: "I share information so everyone is aligned.",
        bcb3_q4_opt_b: "I help the group coordinate and divide responsibilities.",
        bcb3_q4_opt_c: "I propose a way forward and suggest specific actions.",
        bcb3_q4_opt_d: "I take care of what cannot wait.",

        bcb3_q5_stem: "While working with someone, a misunderstanding arises and tension increases. How do you handle it?",
        ...
        bcb3_q7_stem: "You notice a process could be improved. What happens next?",
        bcb3_q7_opt_a: "I run a small trial to see if it works.",
        bcb3_q7_opt_b: "I define a few clear steps and put them into practice immediately.",
        bcb3_q7_opt_c: "I gather input from those involved to find the best way forward.",
        bcb3_q7_opt_d: "I consider the benefits and risks before acting.",

        bcb3_q8_stem: "You need to prepare something important that affects other people. How do you approach it?",
        bcb3_q8_opt_a: "I make sure every detail is handled properly.",
        bcb3_q8_opt_b: "I involve others to shape the best way forward together.",
        bcb3_q8_opt_c: "I identify the most efficient way to get it done.",
