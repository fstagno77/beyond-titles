...
const translations = {
    it: {
        ...
        log_data_loaded: "Loaded survey_archetypes.json v4.0 - {questions} domande, {archetypes} archetipi ({list})",

        // Survey Selector
        survey_selector_label: "Tipo di sondaggio",
        survey_bcb_v3_name: "Behavioural & Competency-Based",
        survey_bcb_v3_short: "Behavioural & Competency-Based v4.0",

        // Behavioural & Competency-Based v4.0 Questions
        ...
        bcb3_q1_opt_c: "Stabilisco una direzione e parto.",
        ...
        bcb3_q4_opt_b: "Analizzo la situazione nel suo insieme e definisco le priorità.",
        ...
        bcb3_q5_opt_b: "Capisco come funziona il nuovo sistema e mi organizzo di conseguenza.",
        ...
        bcb3_q7_opt_a: "Ascolto con attenzione, riformulo e aiuto a riportare calma e rispetto.",
        bcb3_q7_opt_b: "Cerco un punto in comune, costruendo qualcosa che funzioni per entrambi.",
        bcb3_q7_opt_c: "Riporto l'attenzione sull'obiettivo comune e indico il prossimo passo.",
        bcb3_q7_opt_d: "Propongo un'azione pratica da adottare senza aspettare.",
        ...
        bcb3_q9_opt_b: "Punto sulla soluzione più efficace anche nel lungo periodo.",
    ...
    en: {
        ...
        log_data_loaded: "Loaded survey_archetypes.json v4.0 - {questions} questions, {archetypes} archetypes ({list})",
        ...
        // Behavioural & Competency-Based v4.0 Questions
        bcb3_q1_stem: "You have a new task ahead, but few instructions. What's the first thing you do?",
        bcb3_q1_opt_a: "I talk to someone to understand what's important and what comes first.",
        bcb3_q1_opt_b: "I gather the available information and focus on the details.",
        bcb3_q1_opt_c: "I set a direction and get started.",
        bcb3_q1_opt_d: "I start with the first step that produces a tangible result.",

        bcb3_q2_stem: "Something unexpected changes your plans. How do you react?",
        bcb3_q2_opt_a: "I find a practical solution and get going again.",
        bcb3_q2_opt_b: "I try a different approach and adapt quickly.",
        bcb3_q2_opt_c: "I talk to someone and we decide together how to proceed.",
        bcb3_q2_opt_d: "I carefully check what has changed, one step at a time.",

        bcb3_q3_stem: "You need to prepare something important for other people too. How do you proceed?",
        bcb3_q3_opt_a: "I make sure every detail is done well.",
        bcb3_q3_opt_b: "I involve others to build the best way to do it together.",
        bcb3_q3_opt_c: "I find the most concrete way to get it done.",
        bcb3_q3_opt_d: "I introduce an improvement that makes the result more useful.",

        bcb3_q4_stem: "You have several tasks to complete and little time. Where do you start?",
        bcb3_q4_opt_a: "I decide what to tackle first and get to work.",
        bcb3_q4_opt_b: "I analyse the overall situation and set priorities.",
        bcb3_q4_opt_c: "I start with what I can close right away and move on.",
        bcb3_q4_opt_d: "I unblock what's holding everything up.",

        bcb3_q5_stem: "Suddenly, the way you've always done an activity changes. How do you react?",
        bcb3_q5_opt_a: "I promptly test the new method and learn by doing.",
        bcb3_q5_opt_b: "I understand how the new system works and organise myself accordingly.",
        bcb3_q5_opt_c: "I talk with others to outline what works best.",
        bcb3_q5_opt_d: "I follow the new instructions carefully and check they are correct.",

        bcb3_q6_stem: "You notice that a procedure can be improved. What do you do?",
        bcb3_q6_opt_a: "I run a small test to see if it works.",
        bcb3_q6_opt_b: "I choose a few clear steps and apply them immediately.",
        ...
        bcb3_q7_opt_d: "I propose a practical action to take without waiting.",

        bcb3_q8_stem: "In a team project, clarity is lacking and time is running out. How do you step in?",
        bcb3_q8_opt_a: "I share information to get everyone aligned.",
        bcb3_q8_opt_b: "I help the group coordinate and divide up tasks.",
        ...
        bcb3_q9_opt_d: "I try an alternative that might work better.",

        bcb3_q10_stem: "Someone thanks you for your work. What satisfies you most?",
        bcb3_q10_opt_a: "Having achieved a shared result with others.",
        bcb3_q10_opt_b: "Having reached the goal I had set for myself.",
        bcb3_q10_opt_c: "Having fulfilled the responsibility I had.",
        bcb3_q10_opt_d: "Having solved a real problem.",

        // Tiebreaker Q11
        bcb3_q11_stem: "When you make an important decision, what guides you most?",
        bcb3_q11_opt_a: "The final goal I want to reach",
        bcb3_q11_opt_b: "The concrete and immediate result",
        bcb3_q11_opt_c: "The quality and precision of the process",
        bcb3_q11_opt_d: "The involvement and contribution of people",
