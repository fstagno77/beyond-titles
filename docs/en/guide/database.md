...
Beyond uses local JSON files as its database, loaded via Fetch API at application startup. There is no backend or relational database.
...
| ID | Name | Access |
|---|---|---|
| `bcb_v3` | Behavioural & Competency-Based v4.1 | Open (default) |
